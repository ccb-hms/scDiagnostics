...
#'
#' Calculates pairwise distances or correlations between query and
#' reference cells of a specific cell type.
#' 
#' @details The function works with
#'     \code{\linkS4class{SingleCellExperiment}} objects, ensuring
#'     compatibility with common single-cell analysis workflows. It
#'     subsets the data for specified cell types, computes pairwise
#'     distances or correlations, and visualizes these measurements
#'     using density plots. By comparing the distances and
#'     correlations, one can evaluate the consistency and reliability
...
#'     cell types.
#'
#' @param cell_type_query The query cell type for which distances or
#'     correlations are calculated.
#'
#' @param cell_type_reference The reference cell type for which
#'     distances or correlations are calculated.
#'
#' @param distance_metric The distance metric to use for calculating
#'     pairwise distances, such as euclidean, manhattan etc.  Set it
#'     to "correlation" for calculating correlation coefficients.
#'
#' @param correlation_method The correlation method to use when
#'     distance_metric is "correlation".  Possible values: "pearson",
#'     "spearman".
#'
#' @return A plot generated by \code{ggplot2}, showing the density
#'     distribution of calculated distances or correlations.
#'
#' @examples
#' library(scran)
#' library(scRNAseq)
