...
#'
#' @details This function calculates pairwise distances or correlations between query and reference cells 
#' of a specific cell type based on the provided distance or correlation metric. The function works with 
#' \code{\linkS4class{SingleCellExperiment}} objects, ensuring compatibility with common single-cell analysis workflows. 
#' It subsets the data for specified cell types, computes pairwise distances or correlations, 
#' and visualizes these measurements using density plots.
#'
#' @param query_data A \code{\linkS4class{SingleCellExperiment}} object containing numeric expression matrix for the query cells
#' @param reference_data A \code{\linkS4class{SingleCellExperiment}} object containing numeric expression matrix for the reference cells
#' @param query_cell_type_col The column name in the \code{query_data} metadata specifying the cell types
#' @param ref_cell_type_col The column name in the \code{reference_data} metadata specifying the cell types
