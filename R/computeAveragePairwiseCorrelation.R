...
#' ## Note: The cell type annotation method used in this example is SingleR. You can use any other method for cell type annotation and provide the corresponding labels in the colData slot.
