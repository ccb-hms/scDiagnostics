...
#'
#' @description
#' This internal function downsamples \linkS4class{SingleCellExperiment} objects while preserving
...
#'
#' @param sce_object A \linkS4class{SingleCellExperiment} object to potentially downsample.
...
#' @keywords internal
#'
#' @return A \linkS4class{SingleCellExperiment} object with at most max_cells cells
