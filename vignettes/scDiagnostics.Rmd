...
To install the package from Bioconductor use a following command:
...
R version tested: 4.2.3 (2023-03-15) or above
...
allowed - when `use_pcs = FALSE`, the logcounts are used instead.
