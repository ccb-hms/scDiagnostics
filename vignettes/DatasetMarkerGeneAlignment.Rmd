...
# Plot R-squared values showing cell type separation quality
...
plot(regress_res_query, plot_type = "heatmap")
```
...
# Plot overall model fit with variance percentages on PC labels
