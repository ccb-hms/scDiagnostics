...
Next, we use the SingleR package to obtain cell type scores for the query dataset. The scatter plot is generated to examine the relationship between the percentage of mitocondrial genes QC metric and SingleR scores. It allow users to visulaize relation of QC stats for all celltypes or celltypes of interest.
